...
function checking_sc() {
    ...
    IZIN=$(curl -sS https://raw.githubusercontent.com/vermiliion/api/main/register | awk '{print $4}')
...
cd /media/
rm -rf cybervpn
wget https://raw.githubusercontent.com/vermiliion/api/main/botol/cybervpn.zip
unzip cybervpn.zip
cd cybervpn
rm var.txt
rm database.db
...
wget -q -O /media/log-install.txt "https://raw.githubusercontent.com/vermiliion/api/main/botol/log-install.txt"
